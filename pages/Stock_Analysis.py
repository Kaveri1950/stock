...
import datetime
import ta
from pages.utils.plotly_figure import plotly_table, candlestick, RSI, MACD, close_chart
...
with col1:
    ...
    df['1'] = [stock.info['marketCap'], stock.info['beta'], stock.info['trailingEps'], stock.info['trailingPE']]
...
with col2:
    ...
    df['1'] = [stock.info['quickRatio'], stock.info['revenuePerShare'], stock.info['profitMargins'],
